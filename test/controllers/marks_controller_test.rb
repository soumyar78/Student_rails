...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { m1: @mark.m1, m2: @mark.m2, m3: @mark.m3, m4: @mark.m4, m5: @mark.m5, student_id: @mark.student_id } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { m1: @mark.m1, m2: @mark.m2, m3: @mark.m3, m4: @mark.m4, m5: @mark.m5, student_id: @mark.student_id } }
